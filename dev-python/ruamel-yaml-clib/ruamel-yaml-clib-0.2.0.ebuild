...
DESCRIPTION="YAML parser/emitter that supports roundtrip comment preservat"
HOMEPAGE="https://pypi.org/project/ruamel.yaml.clib/ https://bitbucket.org/ruamel/yaml.clib"
MY_PN="${PN//-/.}"
